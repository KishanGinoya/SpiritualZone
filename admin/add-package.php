    ...
    <?php include 'includes/header.php'; ?>
        ...
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Add Package</b></span>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="" method="post" enctype="multipart/form-data">
                            <b>
                                <h2 class="heading">Add Package</h2>
                            </b>
                            <div class="form-group row">
                                <label for="packagename" class="col-sm-3 col-form-label form-label">Package Name</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-input" id="packagename" name="name" autocomplete="off" placeholder="Create / Add Package" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-input" id="packagetype" name="type" autocomplete="off" placeholder="Package Type eg- Family Package / Couple Package" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-input" id="packagelocation" name="location" autocomplete="off" placeholder="Package Location" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control form-input" id="packageprice" name="price" autocomplete="off" placeholder="Package Price" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-input" id="packagefeatures" name="feature" autocomplete="off" placeholder="Package Features Eg-free Pickup-drop facility" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control form-input" id="packagedetails" name="detail" autocomplete="off" placeholder="Package Details" required rows="5" cols="50"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="file" class="form-control-file" id="packageimage" name="image">
                                </div>
                            </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name']) && ($_FILES['image']['name'] != "")) {
                ...
                $sql = "INSERT INTO package(name,type,location,price,feature,detail,image) VALUES('$name', '$type','$location','$price','$feature','$detail','$imageName');";
                $count++;
            } else {
                echo "file not found";
            }
            ...
            if ($result) {
                ...
                echo  "<script>alert('successfully add packages')</script>";
        ?>
                <script>
                    window.location = 'manage-packages.php';
                </script>
        <?php
            } else {
