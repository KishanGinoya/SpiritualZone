    ...
    <?php include 'includes/header.php'; ?>
        ...
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Settings</b></span>
            </div>
                    ...
                    <div class="col-md-12">
                        <form method="post">
                            ...
                            <div class="form-group row">
                                <label for="current" class="col-sm-2 col-form-label form-label">Current Password</label>
                                <div class="col-sm-8">
                                    <input type="password" class="form-control form-input" id="current" name="current" autocomplete="off" placeholder="Enter Current Password" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="new" class="col-sm-2 col-form-label form-label">New Password</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-input" id="new" name="new" autocomplete="off" placeholder="Enter New Password" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="confirm" class="col-sm-2 col-form-label form-label">Confirm Password</label>
                                <div class="col-sm-8">
                                    <input type="password" class="form-control form-input" id="confirm" name="confirm" autocomplete="off" placeholder="Enter Confirm Password" required>
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <div class="col-sm-8 offset-sm-4 btn-container">
                                    <button type="submit" name="submit" class="btn btn-success"><b>Change</b></button>
        ...
        if (isset($_POST['submit'])) {
            ...
            $select="select Password from adminlogin where Username='$nm';";
            ...
            if($s==0){
                $update="update adminlogin set Password='$new' where Username='$nm';";
