    ...
    <?php include 'includes/header.php'; ?>
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Manage Bookings</b></span>
            </div>
            ...
            <div class="table-container">
                <table id="table">
                    <thead>
                        <tr>
                            <th colspan="10" style="background-color: #fff; vertical-align: middle; text-transform: capitalize; padding: 20px;">
                                <h2 class="heading d-flex align-items-center justify-content-between">
                                    <b><span class="heading-text">Manage Booking</span></b>
                                    <a href="add-booking.php">
                                        <button type="button" class="btn btn-primary" style="font-weight: bold;">Add Booking</button>
                                    </a>
                                </h2>
                            </th>
                        </tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $row['fromdate'];
                                            echo ' to ' . $row['todate']; ?></td>
                                        <td><?php echo $row['person'] ?></td>
                                        <!-- <td><a href="add-booking.php"><button type="button" class="btn btn-primary btn-block">Add</button></a></td> -->
                                        <td><a href="update-booking.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success btn-block">Edit</button></a></td>
                                        <td><a href="deletebooking.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-warning btn-block">Delete</button></a></td>
                                    </tr>
                                </tbody>
                            <?php
                            }
