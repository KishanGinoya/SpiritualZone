    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="manage-feedback.php" class="active"><span class="las la-comments"></span>
    ...
    <?php include 'includes/header.php'; ?>
        ...
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Manage User Feedback</b></span>
            </div>
            <?php
                        ...
                        <tr>
                            <th colspan="6" style="background-color: #fff; vertical-align: middle; text-transform: capitalize; padding: 20px;">
                                <h2 class="heading d-flex align-items-center justify-content-between">
                                    <b><span class="heading-text">Manage User Feedback</span></b>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="deletefeedback.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-warning btn-block">Delete</button></a></td>
                                    </tr>
                                </tbody>
                            <?php
                            }
