    ...
    <?php include 'includes/header.php'; ?>
        ...
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Manage Packages</b></span>
            </div>
            ...
            <div class="table-container">
                <table id="table">
                    <thead>
                        <tr>
                            <th colspan="7" style="background-color: #fff; vertical-align: middle; text-transform: capitalize; padding: 20px;">
                                <h2 class="heading d-flex align-items-center justify-content-between">
                                    <b><span class="heading-text">Manage Packages</span></b>
                                    <a href="add-package.php">
                                        <button type="button" class="btn btn-primary" style="font-weight: bold;">Add Packages</button>
                                    </a>
                                </h2>
                            </th>
                        </tr>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <!-- <td><a href="add-package.php"><button type="button" class="btn btn-primary btn-block">Add</button></a></td> -->
                                        <td><a href="update-package.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success btn-block">Edit</button></a></td>

                                        <td><a href="deletepackage.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-warning btn-block">Delete</button></a></td>
                                    </tr>
                                </tbody>
                            <?php
                            }
