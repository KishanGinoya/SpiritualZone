        ...
        <main>
            ...
            <div class="table-container">
                <table id="table">
                    <thead>
                        <tr>
                            <th colspan="6" style="background-color: #fff; vertical-align: middle; text-transform: capitalize; padding: 20px;">
                                <h2 class="heading d-flex align-items-center justify-content-between">
                                    <b><span class="heading-text">Manage Users</span></b>
                                    <a href="add-user.php">
                                        <button type="button" class="btn btn-primary" style="font-weight: bold;">Add User</button>
                                    </a>
                                </h2>
                            </th>
                        </tr>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <!-- <td><a href="add-user.php"><button type="button" class="btn btn-primary btn-block">Add</button></a></td> -->
                                        <td><a href="update-user.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success btn-block">Edit</button></a></td>
                                        <td><a href="deleteuser.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-warning btn-block">Delete</button></a></td>
                                    </tr>
                                </tbody>
                            <?php
                            }
