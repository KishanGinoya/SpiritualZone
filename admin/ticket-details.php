    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="ticket-details.php" class="active"><span class="las la-file-invoice-dollar"></span>
    ...
    <?php include 'includes/header.php'; ?>
        ...
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Ticket Details</b></span>
            </div>
            ...
            <div class="table-container">
                <table id="table">
                    <thead>
                        <tr>
                            <th colspan="11" style="background-color: #fff; vertical-align: middle; text-transform: capitalize; padding: 20px;">
                                <h2 class="heading d-flex align-items-center justify-content-between">
                                    <b><span class="heading-text">Ticket Details</span></b>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $row['fromdate'] . ' to ' . $row['todate'] ?></td>
                                        <td><?php echo $row['person'] ?></td>
                                        <td><?php echo $row['total'] ?></td>
                                        <td><a href="deleteticket.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-warning btn-block">Delete</button></a></td>
                                    </tr>
                                </tbody>
                            <?php
                            }
