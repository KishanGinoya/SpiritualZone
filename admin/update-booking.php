    ...
    <?php include 'includes/header.php'; ?>
        ...
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Update booking</b></span>
            </div>
                    ...
                    <div class="col-md-12">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                <label for="username" class="col-sm-2 col-form-label form-label">name</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-input" id="username" name="name" autocomplete="off" value='<?php echo $row['name']; ?>' placeholder="Enter Username" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email" class="col-sm-2 col-form-label form-label">Email</label>
                                <div class="col-sm-8">
                                    <input type="email" class="form-control form-input" id="email" name="email" autocomplete="off" value='<?php echo $row['email']; ?>' placeholder="Enter Email ID" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="mobileno" class="col-sm-2 col-form-label form-label">Mobile Number</label>
                                <div class="col-sm-8">
                                    <input type="tel" class="form-control form-input" id="mobileno" name="mob" autocomplete="off" maxlength="10" value='<?php echo $row['mobile']; ?>' placeholder="Enter Mobile No." required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="city" class="col-sm-2 col-form-label form-label">City</label>
                                <div class="col-sm-8">
                                    <input type="tel" class="form-control form-input" id="city" name="city" autocomplete="off" value='<?php echo $row['city']; ?>' placeholder="Enter City" required>
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <!-- <input type="text" class="form-control form-input" id="place" name="place" autocomplete="off" value='<?php echo $row['place']; ?>' placeholder="Enter place" required> -->

                                    <select name="place" class="form-control p-10" required>
                                        <option selected><?php echo $selectplace=$row['place']; ?></option>
                                        <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control form-input" id="dateInput" value='<?php echo $row['fromdate']; ?>' name="fromdate" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="dateInput2" class="col-sm-2 col-form-label form-label">To Date</label>
                                <div class="col-sm-8">
                                    <input type="date" class="form-control form-input" id="dateInput2" name="todate" value='<?php echo $row['todate']; ?>' autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="person" class="col-sm-2 col-form-label form-label">person</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control form-input" id="person" autocomplete="off" name="person" value='<?php echo $personres=$row['person']; ?>' placeholder="Enter person" required>
                                </div>
                            </div>
                            <div class="form-group row">
        ...
        if (isset($_POST['submit'])) {
            ...
            if($place != $selectplace){
                ...
                if($checkpriceres){
                    $result = mysqli_fetch_assoc($checkpriceres);
                ...
                $total=$price*$person;
                $updatebook = "update book set name='$name',email='$email',mobile='$mob',city='$city',place='$place',fromdate='$fromdate',todate='$todate',person='$person' where id='$id';";
                $updateticket = "update ticket set name='$name',email='$email',mob='$mob',city='$city',place='$place',price='$price',fromdate='$fromdate',todate='$todate',person='$person',total='$total' where id='$id';";
                $result1 = mysqli_query($con, $updatebook);
                $result2 = mysqli_query($con,$updateticket);
            ...
            if($person != $personres){
                ...
                $updatebook = "update book set name='$name',email='$email',mobile='$mob',city='$city',place='$place',fromdate='$fromdate',todate='$todate',person='$person' where id='$id';";
                $updateticket = "update ticket set name='$name',email='$email',mob='$mob',city='$city',place='$place',fromdate='$fromdate',todate='$todate',person='$person' where id='$id';";
                $result1 = mysqli_query($con, $updatebook);
                $result2 = mysqli_query($con,$updateticket);
            }
            if ($result1 && $result2) {
        ...
        ?>
                <!-- <meta http-equiv="refresh" content="0;url=http://localhost/travel%20project/admin/manage-bookings.php"> -->
        <?php
            } else {
