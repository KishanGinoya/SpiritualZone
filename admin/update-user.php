    ...
    <?php include 'includes/header.php'; ?>
        ...
        <main>
            <div class="custom-link">
                ...
                <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Update User</b></span>
            </div>
                    ...
                    <div class="col-md-12">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-input" id="username" name="name" autocomplete="off" placeholder="Enter Username" value='<?php echo $row['username']; ?>' required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="mobileno" class="col-sm-2 col-form-label form-label">Mobile Number</label>
                                <div class="col-sm-8">
                                    <input type="tel" class="form-control form-input" id="mobileno" name="mob" autocomplete="off" maxlength="10" placeholder="Enter Mobile No." value='<?php echo $row['mob']; ?>' required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email" class="col-sm-2 col-form-label form-label">Email</label>
                                <div class="col-sm-8">
                                    <input type="email" class="form-control form-input" id="email" name="email" autocomplete="off" placeholder="Enter Email ID" value='<?php echo $row['email']; ?>' required>
                                </div>
                            </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            $update = "update register set username='$name',mob='$mob',email='$email' where id='$id';";
        ...
        ?>
                <!-- <meta http-equiv="refresh" content="0;url=http://localhost/travel%20project/admin/manage-users.php"> -->
        <?php
            } else {
