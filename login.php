...
if (isset($_POST['login'])) {
	...
	if (!empty($_POST['remember'])) {
		...
		setcookie('mob', $_POST['mob'], time() + 3600);
	...
	$sql = "SELECT * FROM register WHERE username='$name' AND password='$pass' AND mob='$mob'";
	...
	if ($num_rows == 1) {
		...
		// Check specific conditions and set error messages
		//$sql = "SELECT * FROM Register2 WHERE Name='$name' OR mobileno='$mob' OR Password='$pass'";
		//$result = mysqli_query($con, $sql);
...
<body>
	...
	<div class="signin-form">
		<form action="" method="post">
			...
			<h2 align="center" class="h">Sign In</h2>
			...
			<div class="form-group" style="margin-top: 30px; ">
				<input type="submit" value="Sign In" name="login" class="btn btn-info btn-lg ms-3">
				<input type="reset" value="Reset" class="btn btn-info btn-lg ms-3">
			</div>

		</form>

		<div class="text-center" style="margin-top: 10px; "><a href="register.php">Not Register</a></div>
